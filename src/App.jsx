...
function EcoFlowLogo({ size = 56, withWordmark = true }) {
  return (
    <div className="flex items-center gap-3 select-none">
      <svg width={size} height={size} viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg" className="drop-shadow-xl" aria-label="AI EcoFlow logo">
        <defs>
        ...
        <path d="M100 10c25 0 38 8 53 20s27 29 30 47-2 38-12 54-26 28-42 34-33 6-49 1-31-16-44-31S16 103 18 84s14-36 28-48S75 10 100 10z" fill="url(#g)" />
        <path d="M64 120c30-22 48-36 72-70" stroke="#0B1220" strokeOpacity=".25" strokeWidth="6" strokeLinecap="round" />
    ...
    <div className="min-h-screen w-full bg-slate-900 text-slate-100">
      ...
      <section id="products" className="mx-auto max-w-6xl px-4 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <ProductCard title="EcoFlow LCA Sheet" desc="엑셀/구글시트 기반 자재별 탄소계산 템플릿 + 가이드북." price="$79" badge="Best for Architects" cta="Buy on Gumroad" />
          <ProductCard title="Revit Sustainable Library (Beta)" desc="저탄소 자재 패밀리 & 디테일 템플릿. 초기 설계에 최적." price="$99" badge="BIM" cta="Download" />
          <ProductCard title="EcoFlow Pro SaaS" desc="실시간 LCA 비교 플랫폼 — 설계 결정 속도 10배 향상." price="$29 / mo" badge="Coming Soon" cta="Join Waitlist" />
        </div>
      </section>
