    ...
    <div className="min-h-screen w-full bg-slate-900 text-slate-100" style={{ fontFamily: "'Montserrat', system-ui, sans-serif" }}>
      ...
      <header className="sticky top-0 z-50 backdrop-blur-md bg-slate-900/80 border-b border-white/10 shadow-md">
        <div className="mx-auto max-w-6xl px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <img src="/ecoflow-logo.png" alt="EcoFlow AI Logo" className="h-20 w-auto object-contain" />
            ...
            <motion.div initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.6, delay: 0.05 }} className="relative">
              ...
              <div className="relative rounded-3xl border border-white/10 bg-gradient-to-br from-slate-800 to-slate-900 p-6 shadow-2xl">
                <div className="flex items-center justify-between">
                  <img src="/ecoflow-logo.png" alt="EcoFlow AI Mini Logo" className="h-8 w-auto" />
                  <span className="text-xs text-emerald-200">EcoFlow Pro — MVP</span>
                </div>
                <div className="mt-4 grid grid-cols-3 gap-3 text-center">
                  <div className="rounded-xl bg-white/5 p-3"><div className="text-emerald-300 text-sm font-semibold">-37%</div><div className="text-[10px] text-slate-300">Embodied Carbon</div></div>
                  <div className="rounded-xl bg-white/5 p-3"><div className="text-emerald-300 text-sm font-semibold">+18%</div><div className="text-[10px] text-slate-300">Thermal Efficiency</div></div>
      ...
      <section id="products" className="mx-auto max-w-6xl px-4 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <ProductCard title="EcoFlow LCA Sheet" desc="구글시트/엑셀 기반 자재별 탄소계산 템플릿 + 가이드." price="$79" badge="Architects" cta="Buy on Gumroad" />
          <ProductCard title="Revit Sustainable Library (Beta)" desc="저탄소 자재 패밀리 & 디테일 템플릿." price="$99" badge="BIM" cta="Download" />
          <ProductCard title="EcoFlow Pro SaaS" desc="실시간 LCA 비교 플랫폼 — 초기 의사결정 10×." price="$29 / mo" badge="Coming Soon" cta="Join Waitlist" />
        </div>
      </section>
      ...
      <section id="courses" className="mx-auto max-w-6xl px-4 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          <ProductCard title="AI Eco Design Fundamentals" desc="AI × 건축 설계 핵심 개념을 90분에." price="Free" cta="Start" />
          <ProductCard title="AI + LCA Masterclass" desc="Revit · Sheets · ChatGPT 연계 실전 워크플로우." price="$129" cta="Enroll" />
      ...
      <section id="research" className="mx-auto max-w-6xl px-4 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-4 text-sm">
          <div className="rounded-2xl border border-white/10 p-5 bg-white/5">
            ...
            <p className="text-slate-300 mt-2">수직형 데이터센터 & 폐열 재이용 전략.</p>
          ...
          <div className="rounded-2xl border border-white/10 p-5 bg-white/5">
            ...
            <p className="text-slate-300 mt-2">거주·생산·교육 결합 모듈러 주거 프로토타입.</p>
            <a className="text-emerald-300 text-xs mt-3 inline-block" href="#">Read</a>
          </div>
        </div>
      </section>
      ...
      <section id="consulting" className="mx-auto max-w-6xl px-4 py-16">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div>
            ...
            <p className="mt-3 text-slate-300">개발사·설계사·공공부문을 위한 AI 지속가능 설계 자문. 초기계획, 프로토타입, LCA 자동화까지 전 과정 지원.</p>
            ...
            <div className="mt-6"><CTA>Request Proposal</CTA></div>
          </div>
          <div className="rounded-3xl border border-white/10 bg-white/5 p-6">
            <div className="text-sm text-slate-300">Sample KPI (Quarter)</div>
            <div className="mt-3 grid grid-cols-3 gap-3 text-center">
              <div className="rounded-xl bg-slate-950/50 p-4"><div className="text-emerald-300 font-semibold text-xl">12</div><div className="text-[11px] text-slate-300">Projects</div></div>
              <div className="rounded-xl bg-slate-950/50 p-4"><div className="text-emerald-300 font-semibold text-xl">28%</div><div className="text-[11px] text-slate-300">CO₂e ↓</div></div>
              <div className="rounded-xl bg-slate-950/50 p-4"><div className="text-emerald-300 font-semibold text-xl">4.7★</div><div className="text-[11px] text-slate-300">Client NPS</div></div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="waitlist" className="mx-auto max-w-3xl px-4 py-16">
        <div className="rounded-3xl border border-white/10 bg-gradient-to-br from-emerald-500/10 to-white/5 p-8 text-center">
          <img src="/ecoflow-logo.png" alt="EcoFlow logo" className="mx-auto h-14 w-auto" />
        ...
        <div className="mx-auto max-w-6xl px-4 py-10 grid md:grid-cols-4 gap-8 text-sm">
          <div className="col-span-2">
            <div className="flex items-center gap-3">
              <img src="/ecoflow-logo.png" alt="EcoFlow logo" className="h-10 w-auto" />
              <div className="text-xl font-semibold text-white">EcoFlow AI</div>
            </div>
